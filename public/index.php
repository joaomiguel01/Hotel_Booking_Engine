...
<body class="bg-light">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="#">Faciltiies</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-12 p-0 mb-3">
                                    ...
                                    <textarea class="form-control shadow-none" style="resize: none;" rows="1"></textarea>
                                </div>
                                <div class="col-md-6 ps-0 mb-3">
            ...
            <div class="swiper-wrapper mb-5">
                ...
                <div class="swiper-slide bg-white p-4">
                    ...
                    <p>
                        ...
                        Vitae eum veniam perspiciatis iste ipsa. At dolorem molestias 
                        quis aliquid libero?
                    </p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
                <iframe class="w-100 rounded m-0" height="320px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d252745.8876918009!2d-36.18092734356305!3d-8.18718743514429!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7a98bbebc94490f%3A0xdd09062168eb8b2b!2sCaruaru%20-%20State%20of%20Pernambuco!5e0!3m2!1sen!2sbr!4v1780833216213!5m2!1sen!2sbr" loading="lazy"></iframe>
            </div>
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                ...
                Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Deleniti provident consequuntur non veritatis dolorum fugit 
                nam repellendus, aspernatur in amet tempore architecto nostrum 
                consectetur sed dignissimos distinctio. Sunt, quaerat voluptatem?
            </div>
            <div class="col-lg-4 p-4">
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Design and Developed by MGGGGL12</h6>
