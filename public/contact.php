...
<body class="bg-light">
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="message" class="form-control shadow-none" style="resize: none;" rows="5"></textarea>
                        </div>
    ...
    <?php
        if(isset($_POST['send'])){
            ...
            $q = "INSERT INTO `user_queries`(`name`, `subject`, `email`, `message`) VALUES (?, ?, ?, ?)";
            $values = [$frm_data['name'], $frm_data['subject'], $frm_data['email'], $frm_data['message']];
