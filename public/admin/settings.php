            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="site_about" id="site_about_inp" class="form-control shadow-none" style="resize: none;" rows="6" required></textarea>
                                    </div>
                                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed book hotel room, when shutdown mode is turned on
                        </p>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <iframe src="" class="border p-2 w-100" loading="lazy" id="iframe"></iframe>
                                </div>
                            </div>
        ...
        function add_member(){
            ...
            xhr.onload = function(){
                ...
                if(this.responseText == 'inv_img'){
                    alert('error', 'Only JPG, WEBP, PNG and JPEG images allowed!');
                }
